...
class BorrowingAndReturnControllerTest {
    ...
    public class Borrowing {
        ...
        @Test
        void WhenBorrowingExistsAndThereAvailableBookCopiesButUserNotReturnItThenConflict() throws Exception {
    ...
    public class Returns {
        ...
        void returnBorrowingAndBookAndBorrowingExists() throws Exception {
            MvcResult mvcResult = mockMvc.perform(put("/return/{bookId}/user/{userId}", 1, 1).with(Users.USER_1))
        ...
        void whenReturnBorrowingAndBookNotExistsThenNotFound() throws Exception {
            MvcResult mvcResult = mockMvc.perform(put("/return/{bookId}/user/{userId}", 1000, 1).with(Users.USER_1))
                    .andExpect(status().isNotFound())
                    .andDo(print())
                    .andReturn();
        }
        ...
        void whenReturnBorrowingAndBookExistsAndBorrowingNotExistsThenNotFound() throws Exception {
            MvcResult mvcResult = mockMvc.perform(put("/return/{bookId}/user/{userId}", 2, 1).with(Users.USER_1))
                    .andExpect(status().isNotFound())
                    .andDo(print())
                    .andReturn();
